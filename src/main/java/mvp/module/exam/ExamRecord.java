...
public class ExamRecord {
    ...
    private String examType; // 考试类型编码，MVP阶段固定为县试
    private String questionText; // 本次考试题目原文
    private BigDecimal passThreshold; // 本次考试的通过分数线
    private BigDecimal baseAbilityScore; // 根据人物属性和职业能力算出的基础能力分B
    private BigDecimal randomOffset; // 创建考试时固定下来的综合随机偏移R
    ...
    private BigDecimal AIPlayerContentModifier; // 由AI评价玩家答案后产生的内容修正M
    private BigDecimal finalScore; // 按考试公式得到的最终分数
